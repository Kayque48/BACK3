    ...
    <div class="container-glass">
                    ...
                    <tbody>
                        @forelse($pedidos ?? [] as $pedido)
                            <tr>
                                ...
                                <td style="font-size: 0.9rem;">{{ $pedido->updated_at->format('d/m/Y H:i') }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="6">
        ...
        <div class="stats">
            <div class="stat-card">
                ...
                <div class="number">{{ $pedidos->count() ?? 0 }}</div>
            </div>
            <div class="stat-card">
                <h3><i class="fas fa-check-circle"></i> Concluídos</h3>
                <div class="number" style="color: #10b981;">{{ $pedidos->where('status', 'concluído')->count() ?? 0 }}</div>
            </div>
            <div class="stat-card">
                <h3><i class="fas fa-hourglass-half"></i> Pendentes</h3>
                <div class="number" style="color: #f59e0b;">{{ $pedidos->where('status', 'pendente')->count() ?? 0 }}</div>
            </div>
            <div class="stat-card">
                <h3><i class="fas fa-ban"></i> Cancelados</h3>
                <div class="number" style="color: #ef4444;">{{ $pedidos->where('status', 'cancelado')->count() ?? 0 }}</div>
            </div>
        </div>
    </div>
</body>
