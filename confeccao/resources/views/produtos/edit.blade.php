...
<head>
    ...
    <title>Editar Produto - Confecção</title>
...
<div class="container-glass">
    ...
    <div class="glass-card">
        <div class="card-header">
            <span><i class="fas fa-shirt"></i> Dados do Produto</span>
        ...
        <form action="{{ route('produtos.update', ['produtos' => $produtos->id]) }}" method="POST">
            ...
            <div class="form-group">
                ...
                >{{ old('descricao', $produtos->descricao) }}</textarea>
                @error('descricao')
                    <small style="color: #ef4444; margin-top: 0.25rem; display: block;">{{ $message }}</small>
                @enderror
            </div>
                ...
                <div class="toggle-switch">
                    <label class="switch">
                        <input
                            ...
                            {{ old('reserva', $produtos->reserva) ? 'checked' : '' }}
                        >
                        <span class="slider"></span>
                    </label>
                    <input type="hidden" name="reserva" id="reserva-input" value="{{ old('reserva', $produtos->reserva) ? '1' : '0' }}">
                    <span class="toggle-label" id="reserva-label">
                        {{ old('reserva', $produtos->reserva) ? 'Reservado' : 'Não reservado' }}
                    </span>
                </div>
            </div>
